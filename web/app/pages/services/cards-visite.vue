...
const SERVICE_KEY = 'cards-visite'
const SERVICE_TITLE = 'Cartes de visite'
          ...
          <div class="grid min-w-0 items-stretch gap-4 xl:grid-cols-[minmax(18rem,22rem)_minmax(0,1fr)]">
            <UCard :ui="editorGridColCardUi">
              ...
              <div class="min-w-0 space-y-3">
                ...
                <p class="text-muted text-xs leading-relaxed">Format imprimable VistaPrint : 3,5"×2" (1050×600 @300dpi). Chaque template rend recto + verso côte à côte.</p>
              </div>
            </UCard>
