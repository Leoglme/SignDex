...
const SERVICE_KEY = 'flyer'
const SERVICE_TITLE = 'Flyer'
          ...
          <div class="grid min-w-0 items-stretch gap-4 xl:grid-cols-[minmax(18rem,22rem)_minmax(0,1fr)]">
            <UCard :ui="editorGridColCardUi">
              ...
              <div class="min-w-0 space-y-3">
                ...
                <p class="text-muted text-xs leading-relaxed">Le ZIP nécessite un <strong>client réel</strong>.</p>
              </div>
            </UCard>
            ...
            <template #header>
              <div class="flex min-w-0 flex-col gap-3">
                ...
                <p class="text-muted text-xs leading-relaxed">
                  Liste des variantes et aperçu HTML selon la configuration dans Édition.
                </p>
              </div>
            </template>
